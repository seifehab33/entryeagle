        ...
        <div class="grid lg:grid-cols-3 items-center gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-8">
          <div class="bg-black rounded-lg p-6 max-lg:text-center">
            ...
            <ul class="mt-16 space-y-10">
              <li class="flex items-center max-lg:justify-center">
                ...
                <a
                  href="mailto:EntryEagle@gmail.com"
                  class="text-white text-sm ml-3"
                >
                  <strong>EntryEagle@gmail.com</strong>
                </a>
              </li>
              <li class="flex items-center max-lg:justify-center">
                <svg
                ...
                <Link href="" class="text-white text-sm ml-3">
          ...
          <div class="p-6 rounded-xl lg:col-span-2">
            <form>
              <div class="grid sm:grid-cols-2 gap-8">
                ...
                <div class="relative flex items-center">
                  <input
                    ...
                    class="px-2 py-3 bg-white text-black w-full text-sm border-b-2 focus:border-[#011c2b] outline-none placeholder:text-[#ee5c24] placeholder:text-opacity-[50%]"
                  />
                  <svg
                    fill="#bbb"
                    class="w-[18px] h-[18px] absolute right-2"
              ...
              <button
                type="button"
                class="mt-12 flex items-center justify-center text-sm lg:ml-auto max-lg:w-full rounded px-4 py-2.5 font-semibold bg-[#ee5c24] text-white hover:bg-black transition duration-300  ease-in-out"
              ...
              >
                ...
                <span class="text relative z-10 animate-slideRight ">
                  Send Message
                </span>{" "}
              </button>
              {error && (
